...
# Ensure project root is on path so "src" can be imported from anywhere
...
class LiveTranscriber:
    def __init__(self):
        ...
        self.encoder_path = str(_PROJECT_ROOT / config.get("encoder_path", "models/WhisperEncoder.onnx"))
        self.decoder_path = str(_PROJECT_ROOT / config.get("decoder_path", "models/WhisperDecoder.onnx"))
